				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price"> '.$row['product_price'].'tk <del class="product-old-price">990.00tk</del></h3>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Aditya</h5>
															<p class="date">12 DEC 2021, 11:0- PM</p>
													...
													<li>
														<div class="review-heading">
															<h5 class="name">Seemanta</h5>
															<p class="date">12 DEC 2021, 8:00 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
                        ...
                        echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price tk<del class='product-old-price'>990.00tk</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
